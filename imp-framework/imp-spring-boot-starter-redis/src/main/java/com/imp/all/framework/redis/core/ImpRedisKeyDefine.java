 ...
 */
@Data
public class ImpRedisKeyDefine {
    @Getter
    @AllArgsConstructor
    ...
    private ImpRedisKeyDefine(String memo, String keyTemplate, KeyTypeEnum keyType, Class<?> valueType,
        ...
        // 添加注册表
        ImpRedisKeyRegistry.add(this);
    }

    public ImpRedisKeyDefine(String memo, String keyTemplate, KeyTypeEnum keyType, Class<?> valueType, Duration timeout) {
        this(memo, keyTemplate, keyType, valueType, TimeoutTypeEnum.FIXED, timeout);
    }

    public ImpRedisKeyDefine(String memo, String keyTemplate, KeyTypeEnum keyType, Class<?> valueType, TimeoutTypeEnum timeoutType) {
