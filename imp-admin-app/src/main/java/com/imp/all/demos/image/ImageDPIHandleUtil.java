...
public class ImageDPIHandleUtil {
    ...
    static String sourceImgDir = "E:\\image\\src\\1111.jpg";

    public static void main(String[] args) {
        File inputFile = new File(sourceImgDir);
        handleDpiJPG(inputFile, 300, 300);
    }
...
//            JPEGImageEncoder jpegEncoder = JPEGCodec.createJPEGEncoder(Files.newOutputStream(file.toPath()));
