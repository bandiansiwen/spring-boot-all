 ...
 *
 * 文档地址：http://doc.wupaas.com/docs/easypoi/easypoi-1c0u96flii98v
 *                name：Excel中的列名；
 *               width：指定列的宽度；
...
public class Member {
    ...
    @Excel(name = "MemberID", width = 10, needMerge = true)
    private Long id;
    ...
    private String icon;
    @Excel(name = "性别", width = 10, replace = {"男_0", "女_1"}, addressList = true)
